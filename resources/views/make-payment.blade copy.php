...
<body>
    ...
    <script>
        ...
        document.getElementById('checkout-button').addEventListener('click', function() {
            const amount = document.getElementById('amount').value ; // Convert to cents
            ...
            fetch('/create-stripe-session', {
                ...
                .then(function(data) {
                    if (data.sessionId) {
                        const stripe = Stripe('pk_test_51QdvJ2DkEvCQ3SjebyLqwWQE9iHuWQZTBuDdKNWO95gSlHDZsBG2yH9TDdx9c0a8aDpETtahSAwBqCDHHxoj2Zj100vQV0FqBI'); // Replace with your actual public key
