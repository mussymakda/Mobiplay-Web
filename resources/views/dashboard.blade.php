            ...
            <div class="col-lg-12">
                <div class="create-campaign-box">
                    <div class="campaign-img">
                        <img class="img-fluid" src="{{ asset('assets/images/create-capaign.svg') }}">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="create-campaign-box offer-box">
                        <div class="campaign-img">
                            <img class="img-fluid" src="{{ asset('assets/images/add_money.svg') }}">
                        </div>
                        <div class="campaign-details">
                            <h2>{{ $offer->name }}</h2>
                ...
                <div class="total-box">
                    <div class="total-header">
                        ...
                        <div class="total-right">
                            <img src="{{ asset('assets/images/money-bag.png') }}" style="height: 40px; width: 40px;" alt="Ícono de Saldo Total">
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="total-box" style="color: gray">
                    <div class="total-header">
                        ...
                        <div class="total-right">
                            <img src="{{ asset('assets/images/imp.svg') }}">
                        </div>
                    </div>
                    <div class="total-body">
            ...
            <div class="col-lg-4">
                <div class="total-box" style="color: gray">
                    <div class="total-header">
                        ...
                        <div class="total-right">
                            <img src="{{ asset('assets/images/imp1.svg') }}">
                        </div>
                    </div>
                    <div class="total-body">
            ...
            <div class="col-lg-4">
                <div class="total-box" style="color: gray">
                    <div class="total-header">
                        ...
                        <div class="total-right">
                            <img src="{{ asset('assets/images/imp2.svg') }}">
                        </div>
                    </div>
                    <div class="total-body">
