          ...
          <div class="row align-items-center mb-4">
            <div class="col-xl-2 col-lg-3">
              <div class="page-title">
                <h1 class="mb-lg-0 profile-title">{{ __('about.title') }}</h1>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                      <div class="about-desc">
                        <p>{{ __('about.description.intro') }}</p>
                        <p>{{ __('about.description.mission') }}</p>
                        <p>{{ __('about.description.values') }}</p>
                        <p>{{ __('about.description.team') }}</p>
                        <p>{{ __('about.description.closing') }}</p>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="about-img">
                        <img src="assets/images/about-img.png" class="img-fluid" alt="{{ __('about.title') }}">
                      </div>
                    </div>
